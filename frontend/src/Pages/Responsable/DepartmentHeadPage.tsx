    ...
    return (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-3xl w-full max-w-lg p-8 relative shadow-2xl animate-in fade-in zoom-in duration-200">
                ...
                <div className="mb-8">
                    <h2 className="text-2xl font-bold text-gray-900">{head ? 'Modifier' : 'Nommer'} Chef de Département</h2>
                    <p className="text-gray-500 mt-1 text-sm">Affectez un nouveau responsable à la tête d'un département</p>
                </div>
